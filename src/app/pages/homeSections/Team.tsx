...
function Team() {
  ...
  return (
    <div
      ref={animationRef}
      className="bg-white relative z-30 min-h-[100svh] flex items-center justify-center py-20 lg:pt-0"
    >
      <div className="container mx-auto pt-28 lg:px-5 gap-5 flex-col lg:flex-row px-4 flex items-strech justify-center">
        <div className="team1 w-full">
          ...
          <div className="flex flex-col items-center justify-strech">
            ...
            <div className="font-montserrat cursor-pointer py-1 rounded-[20px] mt-[20px] min-[1820px]:mt-[38px] px-4 bg-[#000] font-medium text-[20px] text-white">
              Know more
            </div>
          </div>
        </div>
        <div className="w-full team2">
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <div className="font-montserrat cursor-pointer py-1 mt-[20px] min-[1820px]:mt-[38px] rounded-[20px] px-4 bg-[#000] font-medium text-[20px] text-white">
              Know more
            </div>
          </div>
        </div>
