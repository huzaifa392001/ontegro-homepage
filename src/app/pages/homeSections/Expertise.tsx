                            ...
                            <SwiperSlide>
                                {({ isActive }) => (
                                    <div className={`human ${isActive ? "scale-115" : ""}`}>
                                        <div className={` mb-10`}>
                                            <Image
                                                className={`${isActive ? "scale-110" : "filter mix-blend-darken brightness-50"
                                                    } lg:!w-[330px] w-[318px]`}
                                                src="/Technician.png"
                                                alt="Hard Services"
                                                width={280}
                                        ...
                                        <h4
                                            className={`font-montserrat leading-[27px] uppercase ${isActive ? "text-[#000000] font-bold text-[28px]" : "text-[#434343] font-semibold text-[22px]"
                                                }`}
                                        >
                                            Hard Services
                                        </h4>
