...
const TechSection = () => {
  ...
  return (
    <section ref={intro1Ref} className="bg-black xl:min-h-screen max-lg:pt-28 lg:py-28 relative">
        ...
        <div className="flex flex-col md:flex-row h-full">
          <div className=" h-full w-full">
            <div className="flex flex-col justify-center items-center h-full text-center">
              <div className="subHeading font-montserrat meet-text font-bold text-2xl md:text-3xl lg:text-4xl xl:text-[46px] 2xl:text-[52px] xl:leading-[54px] 2xl:leading-[63px] text-white mb-3">Meet</div>
              ...
              <h3 className="subHeading font-montserrat sub-title font-medium text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[70px] 2xl:leading-[86px] text-[#5D5D5D]">Your AI Partners in Excellence</h3>
              ...
              <div className="content opacity-0 translate-y-[100%] font-montserrat des-title font-medium text-2xl md:text-3xl lg:text-4xl xl:text-5xl 2xl:text-[70px] 2xl:leading-[86px] text-[#000] max-w-[1254px] mx-auto 2xl:mt-1 mt-7 ">
                Ontegra’s <span className="text-primary">AI-powered</span> duo, providing round-the-clock smart assistance and ensuring seamless operations and customer care
              </div>
            </div>
          </div>
        </div>
