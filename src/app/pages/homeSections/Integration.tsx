...
const Integration = () => {
  ...
  useGSAP(() => {
    gsap.set('.integrationSec .content h1', { scale: 1.5, autoAlpha: 0 })
    gsap.set('.integrationSec .imgCont img', { xPercent: -100, autoAlpha: 0 })
    gsap.set(['.integrationSec .content p', '.integrationSec .content button'], { autoAlpha: 0 })
  ...
  return (
    <section ref={introRef} className="bg-white overflow-hidden lg:min-h-screen relative z-10 pb-28 integrationSec">
